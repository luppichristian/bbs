...
/* Source language used by a target or builder: c, c++, or cuda. */
typedef enum {
  BBS_LANG_C = 0,
  BBS_LANG_CPP,
  BBS_LANG_CUDA,
...
static const bbs_project_lang_alias BBS_PROJECT_LANG_ALIASES[] = {
    {.name = "cuda", .value = BBS_LANG_CUDA},
    {  .name = "cu", .value = BBS_LANG_CUDA},
...
static const bbs_tool_discover_strat BBS_TOOL_DISCOVER_STRATS[] = {
    ...
    {.id = "nvcc", .target_os = BBS_OS_MAX, .exe_name = "nvcc", .dir_hints = "{cuda_path}\\bin;{program_files}\\NVIDIA GPU Computing Toolkit\\CUDA\\*\\bin;{program_files_x86}\\NVIDIA GPU Computing Toolkit\\CUDA\\*\\bin;C:\\CUDA\\bin;/usr/local/cuda/bin;/opt/cuda/bin", .deep_roots = "{program_files};{program_files_x86};/usr/local;/opt", .version_arg = "--version", .version_regex = "release ([0-9]+\\.[0-9]+(\\.[0-9]+)?)"},
...
static const bbs_sdk_discover_strat BBS_SDK_DISCOVER_STRATS[] = {
    ...
    {.id = "cuda_toolkit",     .target_os = BBS_OS_MAX, .env_vars = "CUDA_PATH;CUDA_HOME;CUDA_ROOT;CUDAToolkit_ROOT",                                                                                                                                                                                                                                                    .root_hints = "{cuda_path};{program_files}\\NVIDIA GPU Computing Toolkit\\CUDA\\*;{program_files_x86}\\NVIDIA GPU Computing Toolkit\\CUDA\\*;C:\\CUDA;C:\\Program Files\\NVIDIA GPU Computing Toolkit\\CUDA;{home}/cuda;/usr/local/cuda;/usr/local/cuda-*;/opt/cuda",                            .include_rel = "include",             .source_rel = "samples",                          .lib_rel = "lib64;lib\\x64;lib",                                         .bin_rel = "bin", .version_file_rel = "version.json;version.txt;include\\cuda_runtime.h",                                     .version_regex = "([0-9]+\\.[0-9]+(\\.[0-9]+)?)"},
